...
- Wrapper contract for downstreams:
  - `rzn browser run ...` must behave exactly like `rzn-browser run ...`.
  - No flag translation, no hidden defaults.
- Bundle/release:
...
- `rzn-browser` and `rzn-native-host` are the shipped runtime binaries.
