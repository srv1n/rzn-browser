...
| Understand daemon, runner, leases, or reviewer lane | [[runtime/INDEX]] | [[runtime/CANON]] | Current local browser runtime model: supervisor, native host, extension, legacy worker fallback, sessions, heal, and logs. |
| Change frontmatter, validation, or migration | [[schema/INDEX]] | [[schema/CANON]] | Tusker V6 note schema, workflow manifest v2, run result envelopes, action schemas, templates, validation, and generated boundaries. |
...
| Change lifecycle or close policy | [[workflow/INDEX]] | [[workflow/CANON]] | Workflow contract platform, manifest-shaped workflow files, capability routing, validation, side effects, and smoke proof. |
<!-- tusker:domains:end -->
