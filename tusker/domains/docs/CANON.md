...
summary: "Current durable truth for docs."
aliases:
  - "docs canon"
  - "docs"
source_of_truth:
...
Read this for the current model, invariants, defaults, and boundaries for docs.
...
This domain records current durable truth for docs.
