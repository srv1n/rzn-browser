...
| `crates/rzn_native_host` | Chrome native messaging host; forwards extension messages to supervisor. |
...
- Treating `rzn-browser-worker` or `broker_endpoint_v1.json` as current runtime authority is invalid; those runtime surfaces have been removed.
